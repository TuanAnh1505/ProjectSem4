...
public class EmailService {
    ...
    public void sendActivationEmail(String email, String publicId, boolean isApp) {
                        ...
                        <body style="margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6;">
                            <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px; background-color: #ffffff;">
                                <div style="background-color: #f8fafc; border-radius: 12px; padding: 30px; margin-bottom: 30px; border: 1px solid #e2e8f0;">
                                    <h2 style="color: #1e293b; margin: 0 0 20px; font-size: 24px; font-weight: 600;">Xin chào,</h2>

                                    <p style="color: #475569; margin: 0 0 15px; font-size: 16px;">
                                        Admin đã tạo cho bạn tài khoản hướng dẫn viên trên hệ thống TravelTour.
                                    </p>

                                    <div style="background-color: #ffffff; border-radius: 8px; padding: 20px; margin: 25px 0; border: 1px solid #e2e8f0;">
                                        <p style="margin: 0 0 10px; font-size: 15px; color: #64748b;">
                                            <strong style="color: #334155;">Email đăng nhập:</strong> %s
                                        </p>
                                        <p style="margin: 0; font-size: 15px; color: #64748b;">
                                            <strong style="color: #334155;">Mật khẩu:</strong> %s
                                        </p>
                                    </div>

                                    <p style="color: #475569; margin: 0; font-size: 16px;">
                                        Hãy đăng nhập và đổi mật khẩu sau khi sử dụng lần đầu.
                                    </p>
                                </div>
