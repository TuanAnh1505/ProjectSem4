...
function InternationalNews() {
  return (
    <>
      <div className={styles.vietnamthroughthelensofinternationalnews}>
        ...
        <div className={styles.div47}>
          <div className={styles.column16}>
            <div className={styles.divinfo}>
              ...
              <div
                className={
                  styles.vietnamesebeefPhohasbeenlistedontheTop20OftheworldsbestsoupsbyCnnTravelAs
                }
              >
                Vietnamese beef Pho has been listed on the Top 20 of the world's
                best soups by CNN Travel - a s ...
              </div>
            </div>
          </div>
          <div className={styles.column17}>
            <div className={styles.divinfo}>
              ...
              <div
                className={
                  styles.hoChiMinhCitythemetropolishubofVietnamfeaturesinthetop25Bestplacestogointhe
                }
              >
                Ho Chi Minh City, the metropolis hub of Vietnam features in the
                top 25 best places to go in the ...
              </div>
            </div>
          </div>
          <div className={styles.column18}>
            <div className={styles.divinfo2}>
              ...
              <div
                className={
                  styles.theTimesreveals12BestplacestovisitinVietnamTheTimesFullarticle
                }
              >
                The Times reveals 12 best places to visit in Vietnam _The Times
                Full article
              </div>
            </div>
          </div>
          <div className={styles.column19}>
            <div className={styles.divinfo}>
              ...
              <div
                className={
                  styles.thepearlislandofPhuQuochasearnedaspotinTravelLeisureslistoftopdestinationsto
                }
              >
                The pearl island of Phu Quoc has earned a spot in Travel +
                Leisure's list of top destinations to ...
              </div>
            </div>
          </div>
        </div>
